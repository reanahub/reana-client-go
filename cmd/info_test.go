	...
	tests := map[string]TestCmdParams{
		"default": {
			...
			expected: []string{
				...
				"Default CPU limit for Kubernetes jobs: 2000m",
				"Maximum allowed CPU limit for Kubernetes jobs: 5000m",
				"Default memory request for Kubernetes jobs: 128Mi",
				"Maximum allowed memory request for Kubernetes jobs: 500Mi",
				"Default memory limit for Kubernetes jobs: 2048Mi",
				"Maximum allowed memory limit for Kubernetes jobs: 4Gi",
