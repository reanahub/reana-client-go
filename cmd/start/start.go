...
// Package start provides the command to start previously created workflow.
package start
...
// NewCmd creates a command to start previously created workflow.
...
// validateOptionsAndParams gets the workflow parameters from the server and validates the options and params provided.
